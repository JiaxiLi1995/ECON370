...
# install torch before running the following code
...
######################################################################################################
# Save the trained results so we do not need to retrain the model
# Save the model parameters
torch_save(model$state_dict(), "SimpleLLM.pt")
