...
\begin{itemize}
	...
	\begin{itemize}
    	...
    	\item Clustering, classification, etc
            \item Basic Machine Learning and AI
	\end{itemize}   
\end{itemize}
...
\begin{itemize}
    ...
    % Final Project
    \item Final Project (30\%): Students will present a data project about predicting monthly S\&P500 returns during the scheduled final time. More details on this to come. Group submissions are \textbf{not} allowed for this project. 
\end{itemize}
