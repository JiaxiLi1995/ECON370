...
\newcommand{\SemYear}{2025\xspace}          %Set semester year
...
\author{Jiaxi Li}                                            %Instructor Name
...
\chead{}
\rhead{\footnotesize ECON \CourseNum: Jiaxi Li}
...
Class Hours: TuTh 8:00 AM - 9:15 AM & Office Hours: Th 11:00 AM - 12:00 PM \\
...
ECON \CourseNum is intended to provide a broad-based introduction to numerical and data science methods commonly used in economics. The course will first introduce students to the R programming language, assuming no prior experience. Subsequent lectures, using R, will provide students with the opportunity to apply this knowledge to real-world data to achieve an economic objective.  The methods used in these applications will include (but are not limited to): collecting, cleaning, merging, processing, and visualizing data, supervised/unsupervised statistical learning, cross-validation, trees and basic neural networks.
...
\begin{enumerate}
    \item Teach students how to competently program in R in good style,
...
Upon successful completion of ECON \CourseNum, students should be able to do the following:
...
ECON 101 and a declared Economics major; some background in statistics is recommended.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \href{https://bookdown.org/yihui/rmarkdown-cookbook/}{\textit{R Markdown Cookbook} by Yihui Xie} [R Markdown]
    \end{itemize}
    ...
    % Canvas
    \item \textbf{Canvas:} All announcements, materials, assignments, grades, etc will be posted on the course's Canvas site. Please visit \href{https://uncch.instructure.com/}{\tt\bf uncch.instructure.com}. I will also be posting all materials on the \href{https://github.com/JiaxiLi1995/ECON370}{\tt\bf Github repo} for the course. You may access them however you wish, but assignments will need to be submitted on Canvas. {\tt\bf  \emph{Submitted assignments will only be accepted when submitted on Canvas. No exceptions.}} Any assignment that we have will be able to be submitted on Canvas. If you are having trouble submitting an assignment, it is likely something is incorrect with the submission (e.g. unnecessarily large file, a weird file type, etc). See the course policies below for more details.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
    	\item Introduction to course: the syllabus, R and data visualization with ggplot2
	\end{itemize}
	
	% Module 2
	\item Module 2: R programming (weeks 2-7)
	\begin{itemize}
    	\item Data types and structures
    	\item Objects and the environment
    	\item Logic, loops, and control flow
    	\item Functions
        \item miscellaneous topics (pipeline, dates, regular expressions, etc)
	\end{itemize} 
	
	% Module 3
	\item Module 3: Data Acumen (weeks 8-10)
	\begin{itemize}
    	\item Tidyverse: Loading, cleaning, validation, merging, and processing data
    	\item Datatable: Loading, cleaning, validation, merging, and processing data
	\end{itemize}  
	
	% Module 4
	\item Module 4: Data Science (weeks 11-15)
	\begin{itemize}
    	\item Into to data science and model fitting with OLS, Ridge and LASSO
    	\item Validating and Testing: simulation vs. bootstrap, cross-validation and model evaluation
    	\item Trees and Neural Networks
	\end{itemize}   
\end{itemize}
...
\begin{itemize}
    ...
    % Final Project
    \item Final Project (30\%): Students will present a data project about forecasting monthly S\&P 500 returns during the scheduled final time. More details on this to come. Group submissions are \textbf{not} allowed for this project. 
\end{itemize}
