...
Each question is worth three points. For each section, a "question" corresponse to a number. So each bullet point in "Reading Documentation" section will be worth one point.
