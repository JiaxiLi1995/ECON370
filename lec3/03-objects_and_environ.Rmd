...
PS - Data.frames are lists of vectors, which are all the same size! Each column is an item in the list. You can see this if you run `typeof(d)`. See [here](https://stackoverflow.com/questions/45396538/typeofdata-frame-shows-list-in-r).
